...
const Item = ({ parentid, itemId, driveid, parent }) => {
    ...
    return (
        <div>
            {
                info ? (<Folder parentid={itemId} itemId={folderid.id} driveId={folderid.parentReference.driveId} parent="folder" />) :
                    (back && parentid === iteminfo[0].parentReference.driveId) ? (<Drive driveId={iteminfo[0].parentReference.driveId} siteId={iteminfo[0].parentReference.siteId} />) :
                        (back && parent === "drive") ? (<Drive driveId={iteminfo[0].parentReference.driveId} siteId={iteminfo[0].parentReference.siteId} />) :
                            (back && parent === "folder" && parentid !== iteminfo[0].parentReference.driveId) ? (<Folder itemId={parentid} driveId={iteminfo[0].parentReference.driveId} />) :
                                (
